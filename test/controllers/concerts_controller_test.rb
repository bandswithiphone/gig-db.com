...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { artist: @concert.artist, city: @concert.city, date: @concert.date, venue: @concert.venue }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { artist: @concert.artist, city: @concert.city, date: @concert.date, venue: @concert.venue }
    assert_redirected_to concert_path(assigns(:concert))
  end
